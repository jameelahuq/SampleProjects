...
//let Room = function (dimensions = {}) {
//  let {rmWidth, rmLength } = dimensions;
//  if(!rmWidth || !rmLength) {throw new Error("Missing params"); }
...
//};
//
//House.prototype.addRoom = function (house, newRoom) {
//  this.rooms.push(newRoom);
//};
//
//House.prototype.area = function () {
//  return this.rooms.reduce((tot, e) => { tot + e.area(); }, 0);
//};
...
class Room {
  ...
  area() {return this.rmLength * this.rmWidth}
...
//let rm1 = {rmLength: 10, rmWidth: 10};
//----------
//    Tests
//----------
...
describe("House", () => {
  ...
  //it("allows a house object to be constructed with room objects" , () => {
  //  let room1 = new Room({rmWidth: 7, rmLength: 8});
  //  let room2 = new Room({rmWidth: 5, rmLength: 15});
  //  let house1 = new House("Terra Vista", room1, room2);
  ...
  describe("Room", () => {
    ...
    //it ("allows the user to define multiple rooms", () => {
    //let room1 = new Room;
    //let room2 = new Room;
    //
    //expect(room1).to.be.an('object');
    //expect(room2).to.be.an('object');
...
describe ("addRoom", () => {
  ...
  //it("throws an error if I try to add a room with no dimensions", () => {
  //  let house1 = new House("Terra Vista");
  //});
